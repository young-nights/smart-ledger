...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "dashboard.savingsLeverage": "储蓄杠杆比率",
  ...
  "txn.all": "全部交易",
    ...
    "analysis.assetGrowth": "资产增长与 FIRE 路径",
  ...
  en: {
    ...
    "dashboard.savingsLeverage": "Savings Leverage Ratio",
  ...
  "txn.all": "All Transactions",
    ...
    "analysis.assetGrowth": "Asset Growth & FIRE Path",
    ...
    "analysis.actualAssets": "Actual Assets",

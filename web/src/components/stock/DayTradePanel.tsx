                ...
                {isExpanded && group.matches.length > 0 && (
                  <div style={{ borderTop: "1px solid var(--border-light)", animation: "expandFadeIn 0.25s ease both" }}>
                    ...
                    >
                      ...
                      <span style={{ flex: 1, minWidth: 0, textAlign: "right", marginLeft: 300 }}>买入价</span>
                      <span style={{ flex: 1, minWidth: 0, textAlign: "right", marginLeft: 300 }}>卖出金额</span>
                      <span style={{ flex: 1, minWidth: 0, textAlign: "right", marginLeft: 300 }}>盈亏</span>
                      <span style={{ flex: 1, minWidth: 0, textAlign: "right", marginLeft: 300 }}>数量</span>

        ...
        {sortedData.map((item) => {
          ...
          return (
            ...
            >
              ...
              <div data-stacked style={{ width: "100%", maxWidth: 44, display: "flex", flexDirection: "column", borderRadius: "5px 5px 2px 2px", overflow: "hidden", transition: "filter 0.15s ease" }}>
